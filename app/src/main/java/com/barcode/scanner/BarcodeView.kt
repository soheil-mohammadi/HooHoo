...
import com.barcode.scanner.overlay.BarcodeRectOverlay
import com.barcode.scanner.overlay.Optional
import com.barcode.scanner.scanner.BarcodeScanner
import com.barcode.scanner.scanner.BarcodeScannerConfig
import com.barcode.scanner.scanner.Camera
...
class BarcodeView : FrameLayout {
    ...
    fun setPreviewSize(width: Int, height: Int) = apply {
        config.previewSize = com.barcode.scanner.scanner.Size(width, height)
    }
    ...
    private fun getDisplayMetrics(): com.barcode.scanner.scanner.Size {
        val wm = context.getSystemService(Context.WINDOW_SERVICE) as WindowManager
        val result = DisplayMetrics()
        wm.defaultDisplay.getMetrics(result)

        return com.barcode.scanner.scanner.Size(result.widthPixels, result.heightPixels)
    }
